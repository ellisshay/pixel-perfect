  ...
  return (
    <PageLayout>
      <PageHero
        ...
        sub="אנחנו מחברים בין אנשים שמחפשים פתרונות פיננסיים אמיתיים לבין אנשי מקצוע איכותיים — משכנתאות, פנסיה, ביטוח, השקעות, מיסוי וייעוץ עסקי."
        ctas={[
          { to: "/shitufim", label: "אני רוצה להצטרף כשותף" },
          { to: "/shitufim", label: "איך זה עובד?", variant: "ghost" },
        ]}
      />
