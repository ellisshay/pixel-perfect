  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/85 border-b border-border/60">
      <div className="container mx-auto px-5 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="hidden xl:flex items-center gap-1 text-[13px] font-medium text-muted-foreground">
          {navItems.map((l) => (
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setOpen(!open)} aria-label="תפריט" className="xl:hidden p-2 rounded-lg hover:bg-secondary">
